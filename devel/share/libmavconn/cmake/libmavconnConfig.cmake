...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/mukul/Landing/src/mavros/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/mukul/Landing/devel)
  ...
  set(libmavconn_INSTALL_PREFIX /home/mukul/Landing/install)
...
if(NOT "/home/mukul/Landing/src/mavros/libmavconn/include;/usr/include;/opt/ros/indigo/include;/usr/local/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/mukul/Landing/src/mavros/libmavconn/include;/usr/include;/opt/ros/indigo/include;/usr/local/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mukul/Landing/src/mavros/libmavconn/${idir}'.  Ask the maintainer 'Vladimir Ermakov <vooon341@gmail.com>' to fix it.")
    endif()
    _list_append_unique(libmavconn_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "mavconn;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/local/lib/libconsole_bridge.so")
